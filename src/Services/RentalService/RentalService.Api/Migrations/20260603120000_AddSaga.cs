...
public partial class AddSaga : Migration
{
    ...
    protected override void Down(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.DropColumn(name: "Status", table: "Rentals");
        migrationBuilder.DropColumn(name: "ReservationId", table: "Rentals");
        migrationBuilder.DropColumn(name: "CorrelationId", table: "Rentals");
    }
}
